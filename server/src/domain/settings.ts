...
export const SETTING_DEFAULTS = {
  ...
  atRiskAlertRate: { value: 40, description: 'At-risk rate (%) at or above which a school / grade / learning area is flagged for attention.' },
  tier3AlertRate: { value: 20, description: 'Tier 3 rate (%) at or above which a school is flagged for technical assistance.' },
